import { cv, cvPdf, facebook, github1, gmail, linkedin, logo, phone } from '../assets/index';
    ...
    return (
        <div className=" bg-black-100 pt-8">
            <div className="flex gap-1 items-center justify-center mb-5">
                ...
                <p className={`${styles.sectionSubText} text-center`}>Md. Minhazul Islam Khan</p>
                <img src={logo} className='w-7' alt="" />
            </div>
            <div className="flex sm:flex-row flex-col justify-around overflow-hidden">
                ...
                <div className="flex flex-col justify-center mt-2 sm:mt-0 gap-2">
                    <a href="https://www.facebook.com/mdminhazulislam.khan.77" className="flex gap-4 items-center text-xs" target='_blank'>
                        ...
                        <p className='text-secondary'>facebook.com/mdminhazulislam.khan.77</p>
                    </a>
                    ...
                    <a href={cvPdf} className="flex gap-4 items-center text-xs" target='_blank'>
                        <img src={cv} className="w-7" alt="" />
                        <p className='text-secondary'> Md. Minhazul Islam Khan</p>
                    </a>
                </div>
            </div>
            <p class="text-center text-secondary text-xs mt-3 mb-0">© {new Date().getFullYear()} All Rights Reserved.</p>
        </div>
    );
};
